...
export const api = {
  ...
  conditions: {
    list: () => fetchJson<{ conditions: any[] }>('/conditions'),
    get: (id: string) => fetchJson<{ condition: any; recipes: any[] }>(`/conditions/${id}`),
  },
  wissen: {
    list: () => fetchJson<{ articles: any[] }>('/wissen'),
    get: (id: string) => fetchJson<{ article: any }>(`/wissen/${id}`),
  },
  nutrition: {
