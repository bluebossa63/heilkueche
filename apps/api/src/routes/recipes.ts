...
import type { Recipe } from '@heilkueche/shared';
...
const recipeSchema = z.object({
  ...
  healthTags: z.array(z.enum(['herzfreundlich', 'blutzuckerfreundlich', 'entzuendungshemmend', 'eisenreich', 'cholesterinsenkend', 'verdauungsfoerdernd', 'kalorienarm', 'migraenefreundlich'])).default([]),
